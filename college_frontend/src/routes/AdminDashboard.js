  ...
  return (
    ...
    <div className="h-screen w-screen" class="background">
      <div className="w-full h-full bg-black bg-opacity-40 flex items-center justify-center">
        ...
        { /* first div  */ }
        <div className="w-7/10 h-full bg-black bg-opacity-40 shadow-xl shadow-white">
          <div className="w-full h-1/3 flex flex-col items-center justify-center">
              ...
              <div className="w-8/10 h-1/2 shadow shadow-white rounded-xl flex flex-col items-center justify-center">
                  <div className="w-full h-2/3 border-b rounded-t-xl bg-black bg-opacity-50 backdrop-blur-sm text-2xl font-bold text-red-600 text-center flex justify-center items-center">
                      SHRI RAM MURTI SMARAK COLLEGE OF ENGINEERING & TECHNOLOGY
                  </div>
                  <div className="w-full h-1/3 shadow-xl rounded-b-xl bg-black bg-opacity-50 backdrop-blur-sm font-semibold text-lg text-white text-center flex justify-center items-center">
        ...
        <div className="w-full h-2/3 flex flex-col items-center justify-center">
            <div className="w-full h-2/10 flex items-end justify-center">
                <div className="w-4/10 h-6/10 rounded-md shadow shadow-white bg-black bg-opacity-50 backdrop-blur-sm text-white text-lg flex items-center justify-center">
            ...
            <div className="w-full h-8/10 flex items-center justify-center">
                ...
                <div className="w-full h-8/10 flex items-center justify-center">
                    <div className="w-1/2 h-full flex items-center justify-center">
                        <div className="w-4/10 h-1/2 bg-black bg-opacity-50 backdrop-blur-sm border-2 shadow shadow-white rounded-md flex flex-col items-center justify-center">
                            <div className="w-full h-3/4 rounded-t-md flex items-center justify-center">
                                <Icon icon="hugeicons:students" width="100" />
                            </div>
                    ...
                    <div className="w-1/2 h-full flex items-center justify-center">
                        <div className="w-4/10 h-1/2 bg-black bg-opacity-50 backdrop-blur-sm border-2 shadow shadow-white rounded-md flex flex-col items-center justify-center">
                            <div className="w-full h-3/4 rounded-t-md flex items-center justify-center">
                                <Icon icon="hugeicons:teacher" width="80" />
                            </div>
                            <div className="w-full h-1/4 flex items-center justify-center">
