                ...
                <div className="w-9/10 h-9/10 rounded-xl flex items-center justify-center">
                  <div className="w-full h-full grid grid-cols-3 grid-rows-3">
                    ...
                    <div className="flex items-center justify-center pl-4 pr-4 pt-2 pb-2 rounded-tl-xl row-span-2">
                      <div className="w-9/10 h-95/10 border border-white rounded-xl bg-black bg-opacity-40 backdrop-blur-sm hover:shadow-md hover:shadow-white hover:border-2">
                    ...
                    <div className="flex items-center justify-center pl-4 pr-4 pt-2 pb-2">
                      <div className="w-9/10 h-9/10 border border-white rounded-xl bg-black bg-opacity-40 backdrop-blur-sm hover:shadow-md hover:shadow-white hover:border-2">
                    ...
                    <div className="flex items-center justify-center pl-4 pr-4 pt-2 pb-2">
                      <div className="w-9/10 h-9/10 border border-white rounded-xl bg-black bg-opacity-40 backdrop-blur-sm hover:shadow-md hover:shadow-white hover:border-2">
                        <div className="w-full h-full rounded-xl flex-col items-center justify-center">
                            ...
                            <Link to="/FacultyQuiz" className="w-full h-1/4 font-medium text-white flex items-start justify-center hover:text-blue-400 cursor-pointer">
                              Quiz upload
                            </Link>
                        </div>
                      </div>
