...
// This POST route will help to register an admin.
router.post("/adminRegister",
     async (req, res) => {
    
    // This code is run when the /registerAdmin API is called as POST request
    ...
    // Step 3: create a new admin in the DB
